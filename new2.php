            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="breadcrumb" align=l eft>
                        <marquee behavior="scroll" style="letter-spacing: 5px;">奇奇怪怪血拼fun暑假囉!&nbsp;&nbsp;&nbsp;活動期間:2017/6/12 - 2017/6/17&nbsp;&nbsp;&nbsp;活動將持續六天</marquee>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div id="centerColumn" class="col-xs-9">
                        <div row>
                            <div class="module">
                                ...
                                <br>
                                <div>
                                    <img src = "assets/img/new/2.jpg" width="604" height="825">
                                </div>
                            </div>
                        </div>
                    </div>
