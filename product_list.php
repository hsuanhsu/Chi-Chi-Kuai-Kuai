...
if (!$_GET["Id"])
    ...
    $id = $_GET["Id"];
$sql = "SELECT * FROM product where p_class_id = $id";
?>
...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/css/3-col-portfolio.css">
        ...
        <nav>
            ...
            <div class="col-md-9"> <a href="index.php">首頁</a> <a href="aboutus.php">關於我們</a> <span class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">商品分類<b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li><a href="?Id=1">兒童玩具</a></li>
                    <li><a href="?Id=2">電子產品</a></li>
                    <li><a href="?Id=3">派對小物</a></li>
                    <li><a href="?Id=4">實用小物</a></li>
                </ul>
                    ...
                    <div id="columnLeft" class="col-xs-3">
                        <div row>
                            <div class="module colmn-categories">
                                ...
                                <ul>
                                    <li class="first-level"><a href="?Id=1">兒童玩具</a>
                                    <li class="first-level"><a href="?Id=2">電子產品</a>
                                    <li class="first-level"><a href="?Id=3">派對小物</a>
                                    <li class="first-level"><a href="?Id=4">實用小物</a>
                                </ul>
                            </div>
                        </div>
                        <div row>
                            ...
                            <div class="module colmn-categories">
                                ...
                                <span style="font-size:40px; font-weight:bold;"><? echo substr($str,0,1)?><span>
                                    ...
                                    <div id="centerColumn" class="col-xs-9">
                                        <h1 class="page-heading product-list">
                                            <?
    if ($result = mysqli_query($link, "SELECT * FROM p_class"))
    {
        while ($row = mysqli_fetch_assoc($result))
                                        ...
                                        <div class="block-content">
                                            ...
                                            <div id="products" class="row list-group">
                                                ...
                                                if ($result = mysqli_query($link, $sql))
                                                {
                                                    ...
                                                    mysqli_data_seek($result, ($_GET['page'] - 1) * 6);
                                                    for ($j = 1; $j <= 6; $j++)
                                                    {
                                                ...
                                                <div class="item  col-xs-4 col-lg-4">
                                                    <div class="thumbnail">
                                                       <a href="product_info.php?Id=<?echo $row['p_id'];?>&C=<? echo $row['p_class_id']?>">
                                                            <img class="group list-group-image" src="assets/img/products/<?echo $row["p_id"];?>-1.jpg" alt="" width=250 height=250/>
                                                        </a>
                                                        <div class="caption">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-12 col-md-7">
                                                                    <!--<a class="btn" href="http://">Add to cart</a>-->
                                                                    <button class="btn" style="font-size: 20px; height: 50px; width: 130px;" onclick="location.href='addcart.php?pid=<? echo $row['p_id']?>'">Add to cart</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row" align="center">
                                                    ...
                                                    for ($i = 1; $i <= $total_page; $i++)
                                                    {
                                                        ...
                                                        else echo "<a href='?Id=$id&amp;page=$i'> $i </a>&nbsp;&nbsp;";
                                                    }
                                                    ?>
